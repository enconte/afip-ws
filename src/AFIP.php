...
/**
 * A Laravel wrapper for AFIPWS
 *
 * @package laravel-afipws
...
class AFIP{
     ...
     */
    public function __construct(AFIPWS $afipws, ConfigRepository $config, Filesystem $files, ViewFactory $view){
        $this->afipws = $afipws;
        $this->config = $config;
        $this->files = $files;
        $this->view = $view;

        $this->showWarnings = $this->config->get('afipws.show_warnings', false);
    }
